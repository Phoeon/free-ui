export const c1=`<f-tabs v-model="currentTab" fillMode="none">
...
export const c2=`<f-tabs v-model="currentTab" fillMode="outline">
...
export const c3 = `<f-tabs v-model="currentTab" fillMode="normal">
...
export const c4 =`<f-tabs v-model="currentTab" fillMode="reverse">
    <f-tab-panel icon="chrome" title="案例展示" :disabled="false">panel1</f-tab-panel>
    <f-tab-panel icon="firefox" title="脚本案例" :disabled="false">panel2</f-tab-panel>
    <f-tab-panel icon="safari" title="样式案例" >panel3</f-tab-panel>
</f-tabs>`