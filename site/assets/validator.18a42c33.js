import{d as _,r as E,k as c,I as j,a as y,f as F,l as r,w as t,u as e,y as v,o as I,A as p,p as b}from"./vendor.6c48bfff.js";import{g as h}from"./gen-code.94dbf386.js";import{_ as k,D as V}from"./index.898e7603.js";import{a as w,b as C,c as u}from"./form-input.de427f0e.js";import{_ as q}from"./main.9982799e.js";import"./input-wrap.c34eff16.js";const U={class:"www-doc"},T={class:"www-doc-left"},$=p("\u63D0\u4EA4\u8868\u5355"),M={class:"www-doc-right","sm-visible":"false"},J=_({setup(S){const o=E({required:"",number:"",email:"",url:"",mobile:"",regexp:"",chinese:"",helloworld:"",len:""}),m=c(),g=()=>{var i;(i=m.value)==null||i.validForm().then(()=>{V.success("\u9A8C\u8BC1\u901A\u8FC7")}).catch(a=>{V.error("\u9A8C\u8BC1\u5931\u8D25")})},B=(i,a,n,l)=>{i==="helloworld"?n():l({tip:"\u8BF7\u8F93\u5165helloworld"})},x=(i,a,n,l)=>{const d=i.length,[D,A]=a;d>=D&&d<=A?n():l({tip:"\u4F60\u4E0D\u8BC6\u6570\u4E48\uFF1F\uFF1F\uFF1F5-10\u4F4D\u54C8"})},s={parts:[{title:"\u5185\u7F6E\u9A8C\u8BC1\u5668",nowrap:!1,type:"card",id:"nav_0",template:`    <f-form title="">
