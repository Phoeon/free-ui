import{d as k,N as I,r as N,c as A,z as j,s as O,W as z,o as c,a as d,f as E,b as x,u as e,n as M,g as D,F as $,B as S,m as T,k as U,I as V,l as u,w as t,A as a,p as v}from"./vendor.adc10202.js";import{g as C}from"./gen-code.94dbf386.js";import{g as L}from"./index.513ab18a.js";import{_ as P}from"./main.90288d63.js";const W=["onClick","active"],g=k({props:{index:{type:Number,default:0},interval:{type:Number,default:5e3},autoplay:{type:Boolean,default:!0},indicator:{type:Boolean,default:!0},indicatorOutside:Boolean,direction:{type:String,default:"hr"}},emits:["update:modelValue","shift"],setup(f,{emit:l}){var b;const n=f,h=I(),_=((b=h.default)==null?void 0:b.call(h))||[],i={timer:-1},r=N({value:n.index||0}),m=A(()=>{const s=-r.value*100;return{transform:n.direction==="hr"?`translate3d(${s}%,0,0)`:`translate3d(0,${s}%,0)`}}),p=A(()=>({"ph-carousel-indicators":!0,"ph-cid-abs":n.direction=="vt"||!n.indicatorOutside})),y=s=>{r.value=s,l("shift",s)},F=s=>{s!==r.value&&(n.autoplay&&clearInterval(i.timer),y(s),n.autoplay&&w())},w=()=>{i.timer=setInterval(()=>{y((r.value+1)%_.length)},n.interval)};return j(()=>{n.autoplay&&_.length&&O(w)}),z(()=>{clearInterval(i.timer)}),(s,_e)=>(c(),d("div",{class:D(["ph-carousel","ph-carousel-"+f.direction])},[E("div",{class:"ph-carousel-container",style:M(e(m))},[x(s.$slots,"default",{active:e(r).value})],4),f.indicator?(c(),d("div",{key:0,class:D(e(p))},[x(s.$slots,"indicator",{active:e(r).value,shift:F},()=>[(c(!0),d($,null,S(e(_),(me,B)=>(c(),d("div",{class:"ph-carousel-indicator",onClick:pe=>F(B),active:B===e(r).value,key:B},null,8,W))),128))])],2)):T("v-if",!0)],2))}}),q={},G={class:"ph-carousel-item"};function H(f,l){return c(),d("div",G,[x(f.$slots,"default")])}var o=L(q,[["render",H]]);const J={class:"www-doc"},K={class:"www-doc-left"},Q=a("\u5361\u7247\u4E00"),R=a("\u5361\u7247\u4E8C"),X=a("\u5361\u7247\u4E09"),Y=a("\u5361\u7247\u56DB"),Z=a("\u5361\u7247\u4E00"),ee=a("\u5361\u7247\u4E8C"),te=a("\u5361\u7247\u4E09"),ue=a("\u5361\u7247\u56DB"),ae=a("\u5361\u7247\u4E00"),oe=a("\u5361\u7247\u4E8C"),ne=a("\u5361\u7247\u4E09"),se=a("\u5361\u7247\u56DB"),le=a("\u5361\u7247\u4E00"),re=a("\u5361\u7247\u4E8C"),ie=a("\u5361\u7247\u4E09"),ce=a("\u5361\u7247\u56DB"),de=["active","onClick"],fe={class:"www-doc-right","sm-visible":"false"},ge=k({setup(f){const l={parts:[{title:"\u57FA\u672C\u6848\u4F8B",nowrap:!1,type:"card",id:"nav_0",template:`    <f-carousel>
