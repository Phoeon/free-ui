import{d as b,k,r as U,z,W as H,o as E,e as I,w as a,b as $,u,m as W,j as J,y as K,I as T,a as O,f as p,l as t,A as c,p as h}from"./vendor.adc10202.js";import{g as A}from"./gen-code.94dbf386.js";import{h as Q,_ as X,s as j,x as Y,y as Z,j as tt,a8 as l,a as ot,i as et}from"./index.513ab18a.js";import{_ as C}from"./group.c7619c52.js";import{_ as at}from"./main.90288d63.js";const i=b({props:{dataSource:{type:Array,default:()=>[]},position:{type:String,default:"bc"},trigger:{type:String,default:"hover"},theme:String,offset:{type:Number,default:12},icon:String},emits:["action"],setup(S,{emit:g}){const o=S;let e;const r=k(),n=U({open:!1,lock:!1,enter:!1}),d=()=>{!n.open||(e==null||e(),n.open=!1,n.enter=!1)},w=s=>{d(),g("action",s)},f=()=>{n.enter=!0},x=()=>{n.open=!1,n.enter=!1},_=(s,B)=>{if(n.lock)return;n.lock=!0,n.open=!0;const{left:m,top:v,width:D,height:F}=s.getBoundingClientRect(),{dataSource:N,position:L,theme:G}=B,y=L||"bc",P=j(Y[y],[m,v,D,F]),R=j(Z[y],[m,v,D,F]);e=tt.showDropdown({dataSource:N,x:P,y:R,height:F,theme:G,position:y,offset:o.offset}).done(w).enter(f).leave(x).hide,window.setTimeout(()=>{n.lock=!1},300)},V=()=>{o.trigger==="click"&&(n.open||_(r.value.$el,{dataSource:o.dataSource,position:o.position,theme:o.theme}))},q=()=>{o.trigger==="hover"&&(n.open||_(r.value.$el,{dataSource:o.dataSource,position:o.position,theme:o.theme}))},M=()=>{o.trigger==="hover"&&(!n.open||window.setTimeout(()=>{n.enter||d()},50))};return z(()=>{document.addEventListener("click",d)}),H(()=>{document.removeEventListener("click",d)}),(s,B)=>(E(),I(X,{dropdown:u(n).open?"up":"down",onMouseenter:q,onMouseleave:M,onClick:J(V,["stop"]),ref:(m,v)=>{v.edom=m,K(r)&&(r.value=m)}},{leftIcon:a(()=>[$(s.$slots,"leftIcon",{},()=>[S.icon?(E(),I(u(Q),{key:0,name:S.icon},null,8,["name"])):W("v-if",!0)])]),default:a(()=>[$(s.$slots,"default")]),_:3},8,["dropdown","onClick"]))}}),ut={class:"www-doc"},nt={class:"www-doc-left"},rt=p("h2",{id:"nav_0",class:"www-title"},"\u52A8\u6001\u5C55\u793A",-1),ct=c("\u4E0B\u5DE6"),it=c("\u4E0B\u4E2D"),dt=c("\u4E0B\u53F3"),st=p("br",null,null,-1),pt=c("\u4E0A\u5DE6"),lt=c("\u4E0A\u4E2D"),ft=c("\u4E0A\u53F3"),mt={style:{margin:"16px",display:"flex",gap:"16px","flex-wrap":"wrap"}},St={style:{margin:"16px",display:"flex",gap:"16px","flex-wrap":"wrap"}},wt={class:"www-doc-right","sm-visible":"false"},Ft=b({setup(S){const{CustomIcon:g}=ot,o=d=>{et.show(d.text)},e={content:"\u63CF\u8FF0\u6587\u5B57\u63CF\u8FF0\u6587\u5B57",dataSource:[{text:"\u6DFB\u52A0\u670B\u53CB",value:1,icon:"chrome"},{text:"\u53D1\u8D77\u7FA4\u804A",value:1,icon:"firefox"},{text:"\u626B\u4E00\u626B",value:1,icon:"safari"},{text:"\u6211\u7684\u4E8C\u7EF4\u7801/\u6536\u6B3E",value:1,icon:"opera"},{text:"\u5E2E\u52A9\u4E2D\u5FC3",value:1,icon:"internet-explorer"}]},r={parts:[{title:"\u52A8\u6001\u5C55\u793A",template:"\u52A8\u6001\u5C55\u793A",type:"h2",nowrap:!0,id:"nav_0"},{title:"hover\u89E6\u53D1",nowrap:!1,type:"card",id:"nav_1",template:`    <f-button-group :container="true">
